        ...
        return (
          <Link
            ...
            className={clsx(
              ...
              {
                'bg-sky-100 text-blue-600 hover:text-blue-700 transition transition-duration-200 dark:bg-sky-100 dark:text-blue-400 dark:hover:text-blue-600': pathname === link.href,
              },
            )}
          >
